...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/ma35h0-vc8000.ko_${PREFERRED_VERSION_linux-ma35h0} \
		${D}/${base_libdir}/modules/${PREFERRED_VERSION_linux-ma35h0}/ma35h0-vc8000.ko
}

addtask do_install after do_compile
FILES_SOLIBSDEV = ""
FILES_${PN} = "${base_libdir}/modules/${PREFERRED_VERSION_linux-ma35h0}/ma35h0-vc8000.ko ${bindir}/vc8000-h264"
