...
do_install() {
    ...
    install -m 0644 ${WORKDIR}/galcore.ko_${PREFERRED_VERSION_linux-ma35h0} \
		${D}/${base_libdir}/modules/${PREFERRED_VERSION_linux-ma35h0}/galcore.ko
}

FILES_SOLIBSDEV = ""
FILES_${PN} = "${libdir}/directfb-${RV}/gfxdrivers/libdirectfb_gal.so ${libdir}/libGAL.so ${base_libdir}/modules/${PREFERRED_VERSION_linux-ma35h0}/galcore.ko"
